...
import { useEnsaios } from '../../hooks/useEnsaio'

export default function RecentActivity() {
  const { ensaios, loading } = useEnsaios()
    ...
    >
      ...
      <div className="flex-grow-1">
        {loading ? (
          ...
          ensaios.map((activity, index) => (
            <div key={activity.id || index} className="position-relative ps-4 py-2">
              {index !== ensaios.length - 1 && (
                <div
              ...
              <div
                ...
                style={{
                  ...
                  border: `2px solid ${activity.dotColor || 'var(--lab-primary)'}`,
                  zIndex: 1,
                }}
              >
                <div className="rounded-circle" style={{ width: 8, height: 8, backgroundColor: activity.dotColor || 'var(--lab-primary)' }} />
              </div>
