...
export default class Amostra {
  ...
  constructor(
    ...
    this._situacaoAmostra = Amostra.validarSituacao(situacaoAmostra);
  ...
  get nomeAmostra() {
    return this._nomeAmostra;
  }
  get tipoAmostra() {
    return this._tipoAmostra;
  }
  get situacaoAmostra() {
    return this._situacaoAmostra;
  }
  get dataCad() {
  ...
  // --- MÉTODOS AUXILIARES ---
  private static validarSituacao(valor: any): enumSituacaoAmostra {
        ...
        return valor as enumSituacaoAmostra;
    }
